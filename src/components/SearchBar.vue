<template>
  <div
    class="text-gray-300 backdrop-blur-[20px] absolute top-1/4 left-1/2 -translate-x-1/2 rounded-full w-60 max-w-4/5 h-10 transition-[width background] flex items-center justify-center duration-300 bg-white/15 px-4 cursor-pointer z-50"
    :class="{
